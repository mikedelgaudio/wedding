  ...
  return (
    <>
      ...
      <p className="text-2xl">
        ...
        remember, Lynh joked, “The only thing I know about Staten Island is that
        Pete Davidson is from there,” while Mike asked if Minnesota was{' '}
        <span className="italic">really</span> that cold.
      </p>
      <p className="text-2xl">
        The very next day, as Lynh was walking back to her hotel with groceries,
        she ran into Mike again. As it turned out, not only were they working
        for the same company and same org—they were staying at the same hotel,
        on the same floor.
      </p>
      <p className="text-2xl">
      ...
      <p className="text-2xl">
        ...
        using it to survive hotel living. So when he lost another hand, he upped
        the ante: he'd cook Lynh dinner. Skeptical—but also hungry—Lynh
        eventually took him up on the offer.
      </p>
      <p className="text-2xl">
        Mike made a surprisingly good air fryer chicken dinner, and over dinner,
        they played another round of poker—just the two of them this time. After
        yet another loss, Mike decided to raise the stakes: “If I win the next
        hand, I get to take you out on a{' '}
        <span className="font-bold">proper date.</span>” Given his track record,
        Lynh didn't worry.
      </p>
      <p className="text-2xl">But as fate would have it, Mike won.</p>
      <p className="text-2xl">
      ...
      <p className="text-2xl">
        After college, Mike and Lynh both returned to Redmond for work and have
        been living there ever since!
      </p>
      <h3 className="text-2xl font-bold mt-4">The Proposal</h3>
      <p className="text-2xl">
        One of Lynh's most favorite places on Earth is the annual Tulip Festival
        in Northern Washington. For her birthday, Mike surprised Lynh with a
        photoshoot at the festival. However, Mike had more planned than just a
        photoshoot.
      </p>
      <p className="text-2xl">
        On April 4th, 2025 Mike proposed in front of the first blooms of Spring.
      </p>
      <ResponsiveFigure
